...
1. __main.py__ lê comando do stdin via `communication.read_command()`
...
✅ __Responsabilidade única__: Cada módulo tem uma função clara
✅ __Testabilidade__: Módulos isolados são fáceis de testar
✅ __Manutenibilidade__: Mudanças localizadas não afetam o sistema todo
✅ __Escalabilidade__: Fácil adicionar novos exportadores ou executores
✅ __Clareza__: `main.py` é simples e legível
✅ __Compatibilidade__: Interface stdin/stdout mantida com Electron
